 ...
 * @author inta
 * @date 2021/5/8
 * @describe 你正在经营一座摩天轮，该摩天轮共有 4 个座舱 ，每个座舱 最多可以容纳 4 位游客 。
 ...
 */
public class Q1599minOperationsMaxProfit {
    public int minOperationsMaxProfit(int[] customers, int boardingCost, int runningCost) {
        if (boardingCost * 4 <= runningCost) {
            return -1;
        }
        int standardValue = boardingCost * 4 - runningCost;
        int max = 0;
        int index = 0;
        int maxIndex = -1;
        int cur = 0;
        ...
        for (int customer : customers) {
            ...
            if (resume >= 4) {
                ...
                cur += boardingCost * resume - runningCost;
                resume = 0;
            }
            if (max < cur) {
                max = cur;
